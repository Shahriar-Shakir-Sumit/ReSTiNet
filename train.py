...
sess = tf.InteractiveSession(config=tf.ConfigProto(gpu_options=gpu_options,intra_op_parallelism_threads=6, inter_op_parallelism_threads=6,device_count={'CPU': 6}))
